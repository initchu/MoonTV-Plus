...
export interface DownloadProgress {
  ...
  current: number; // 当前下载的分片数
  total: number; // 总分片数
}

// 合集下载进度
export interface PlaylistDownloadProgress {
  currentEpisode: number; // 当前下载的集数
  totalEpisodes: number; // 总集数
  episodeProgress: number; // 当前集数的下载进度（0-100）
}
...
export interface DownloadTask {
  ...
  progress: DownloadProgress | null; // 单集下载进度
  playlistProgress: PlaylistDownloadProgress | null; // 合集下载进度
